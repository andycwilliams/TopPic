...
const MainLandingPage = ({handlePageChange, currentPage}) => {
    return (
        <div className='flex flex-col justify-center items-center w-2/4 h-screen bg-gray-200 bg-opacity-90'>
            ...
            <div>
          <p className="m-1 absolute top-0 left-0 bg-gray-200 rounded-lg"><p><a href="https://github.com/andycwilliams/TopPic">view the github repository for this project</a></p></p>
        </div>
