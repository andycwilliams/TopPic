                ...
                <div class="relative border-dashed h-20 rounded-lg border-dashed border-2 border-green-900 bg-gray-100 flex justify-center items-center">
                  <div class="absolute">
                    <div class="flex flex-col items-center"> 
                      ...
                      <span class="block text-gray-400 font-normal text-center">Upload<br/>(jpg, png, svg, jpeg)</span> 
                    </div>
                  </div>
                  <input onChange={handleImageUpload} type="file" id="img" name="img" accept="image/*" class="h-full w-full opacity-0" />
                </div>
              </div>
            </div>
          </div>
